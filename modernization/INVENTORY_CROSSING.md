...
La suite incluye pruebas de validación de solicitudes y selección del último reconteo por grupo. Estas pruebas no ejecutan las nuevas transacciones contra SQL Server. Pendiente: ejecución de las transacciones contra copia SQL, caracterización con inventario real y ajustes SAP. Esta funcionalidad no declara completado todo el módulo.
