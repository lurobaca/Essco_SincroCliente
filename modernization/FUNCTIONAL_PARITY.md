...
| Catálogos operativos | Motivos, rutas, bodegas, bodegueros, agentes, choferes, bancos y razones de no visita | Motivos de devolución, rutas, bancos, razones de no visita, bodegas WMS y bodegueros implementados; restantes en migración | Analizando | Validar esquemas reales, bodegas SAP y relaciones SQL |
