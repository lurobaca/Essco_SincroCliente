...
| Catálogos operativos | Motivos, rutas, bodegas, agentes, choferes y bancos | Motivos de devolución implementados; restantes en migración | Analizando | Validar bodegas SAP y relaciones SQL |
