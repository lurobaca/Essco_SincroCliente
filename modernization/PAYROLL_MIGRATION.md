...
La creación y los cambios de estado invocan los procedimientos existentes con parámetros tipados y respetan sus códigos de salida. La planilla de aguinaldo valida montos pendientes y fuerza el período legal del 1 de diciembre al 30 de noviembre. El detalle permite descargar el TXT bancario compatible con los registros heredados `HD`/`DA`, validando cuentas, identificadores y montos antes de generarlo. Antes del piloto se deben ejecutar pruebas de caracterización con una copia SQL para incapacidades, vacaciones, liquidaciones laborales, deducciones fijas, préstamos y asiento contable.
