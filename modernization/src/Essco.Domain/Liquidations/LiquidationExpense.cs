...
{
 public int Id{get;init;}public required string DocumentNumber{get;init;}public required string Category{get;init;}public decimal Amount{get;init;}public required string Description{get;init;}public int? LiquidationNumber{get;init;}public required string LiquidationType{get;init;}public required string EmployeeCode{get;init;}public DateOnly Date{get;init;}public bool IsElectronicInvoice{get;init;}public required string SupplierCode{get;init;}public bool IncludeInLiquidation{get;init;}public bool IsAnnulled{get;init;}public required string HaciendaStatus{get;init;}
