...
Public Class RepCargaSector1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.RepCargaSector1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepCargaSector1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepCargaSector1 = New RepCargaSector1()
        rpt.Site = Me.Site
        Return rpt
    End Function
