...
Public Class ResumenLiqChoferes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.ResumenLiqChoferes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResumenLiqChoferes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ResumenLiqChoferes = New ResumenLiqChoferes()
        rpt.Site = Me.Site
        Return rpt
    End Function
