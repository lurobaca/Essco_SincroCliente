...
Public Class ResumenLiqAgentes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.ResumenLiqAgentes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResumenLiqAgentes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ResumenLiqAgentes = New ResumenLiqAgentes()
        rpt.Site = Me.Site
        Return rpt
    End Function
