...
Public Class LiquidacionAgentes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.LiquidacionAgentes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLiquidacionAgentes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LiquidacionAgentes = New LiquidacionAgentes()
        rpt.Site = Me.Site
        Return rpt
    End Function
