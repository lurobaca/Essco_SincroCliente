Public Class Lista_Depositos

    Dim FINI As String
    Dim FFIN As String

    Private Sub Lista_Depositos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Class_VariablesGlobales.CodAgenteLiq <> "" Then
            txtb_CodAgente.Text = Class_VariablesGlobales.CodAgenteLiq
        End If
        ...
        Else
            dgv_Liquidaciones.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneDepositos(Class_VariablesGlobales.SQL_Comman1, "VENTANA_DEPOSITO", "", FINI, FFIN, txtb_CodAgente.Text, Txb_NumDepo.Text, Txb_Consecutivo.Text, "", "DPCONSECUTIVO", Class_VariablesGlobales.LIQUIDANDO, chbx_VerAnulado.Checked, "")
        End If
    ...
    Private Sub Lista_Depositos_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Admin_Depositos_Agentes.TopMost = True
    End Sub
    ...
    Private Sub dgv_Liquidaciones_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_Liquidaciones.CellContentDoubleClick
        Try
