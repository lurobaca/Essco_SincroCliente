...
Public Class PlanillaFinal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.PlanillaFinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPlanillaFinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PlanillaFinal = New PlanillaFinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
