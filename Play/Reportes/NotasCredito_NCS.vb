...
Public Class NotasCredito_NCS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.NotasCredito_NCS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotasCredito_NCS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotasCredito_NCS = New NotasCredito_NCS()
        rpt.Site = Me.Site
        Return rpt
    End Function
