...
Public Class HojaCarta_FE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.HojaCarta_FE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHojaCarta_FE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HojaCarta_FE = New HojaCarta_FE()
        rpt.Site = Me.Site
        Return rpt
    End Function
