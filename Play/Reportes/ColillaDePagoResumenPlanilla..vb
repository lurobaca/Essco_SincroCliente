...
Public Class ColillaDePagoResumenPlanilla
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ColillaDePagoResumenPlanilla..rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.ColillaDePagoResumenPlanilla..rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdPlanilla() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedColillaDePagoResumenPlanilla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ColillaDePagoResumenPlanilla = New ColillaDePagoResumenPlanilla()
        rpt.Site = Me.Site
        Return rpt
    End Function
