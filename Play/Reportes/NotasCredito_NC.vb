...
Public Class NotasCredito_NC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.NotasCredito_NC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotasCredito_NC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotasCredito_NC = New NotasCredito_NC()
        rpt.Site = Me.Site
        Return rpt
    End Function
