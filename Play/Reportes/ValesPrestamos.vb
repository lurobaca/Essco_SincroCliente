...
Public Class ValesPrestamos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.ValesPrestamos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValesPrestamos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValesPrestamos = New ValesPrestamos()
        rpt.Site = Me.Site
        Return rpt
    End Function
