...
Public Class HojaCarta_FES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SincroCliente.HojaCarta_FES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHojaCarta_FES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HojaCarta_FES = New HojaCarta_FES()
        rpt.Site = Me.Site
        Return rpt
    End Function
