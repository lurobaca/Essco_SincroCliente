Public Class Detalle_Gastos

    Public NuevoSistem As Boolean = False
    Public Empleado As String
    Public EsFE As String = "true"
    Private Sub Detalle_Gastos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Class_VariablesGlobales.LIQUIDANDO = "CHOFERES" Then
            ...
            'txb_Liquidacion.Text = NumLiqChoferLiq
        ...
        If Class_VariablesGlobales.Gastos_llamadaDesde = "LIQUIDACION" Then
            ...
            If Class_VariablesGlobales.LIQUIDANDO = "CHOFERES" Then
                dgv_DetGastos.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosChoferes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.NumLiqui, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Class_VariablesGlobales.Chofer, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), "", "", False, CBox_IncluidoEnLiquidacion.Checked)
                txb_Total.Text = FormatCurrency(Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneTotalGastosChoferes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.NumLiqui, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Class_VariablesGlobales.Chofer, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), False, False, True), 2, True)
            ...
            Else
                ...
                txb_Total.Text = FormatCurrency(Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneTotalGastosAgentes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Class_VariablesGlobales.Agente, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), False, False), 2)
    ...
    Private Sub btn_AgGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_AgGuardar.Click
        ...
        If btn_AgGuardar.Text = "GUARDAR" Then
            ...
            ElseIf txb_Monto.Text = "" Then
                ...
                Exit Sub
            ElseIf txb_NumDoc.Text = "" And RBt_SI.Checked = True Then
                MsgBox("Debe ingresar el Numero de Factura del Gasto")
                Exit Sub
            ElseIf txb_Cedula.Text = "" And RBt_NO.Checked = True Then
                MsgBox("Debe ingresar el proveedor para generar la Factura Electronica de Compra")
                Exit Sub
            Else
                ...
                If Class_VariablesGlobales.Gastos_llamadaDesde = "LIQUIDACION" Then
                    ...
                    dgv_DetGastos.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosAgentes(Class_VariablesGlobales.SQL_Comman1, "", Class_VariablesGlobales.TituloDetalleGasto, Empleado, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), "", "", False, CBox_IncluidoEnLiquidacion.Checked)
                    txb_Total.Text = FormatCurrency(Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneTotalGastosAgentes(Class_VariablesGlobales.SQL_Comman1, "", Class_VariablesGlobales.TituloDetalleGasto, Empleado, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), False, False), 2)
                ...
                If problema = False Then
                    ...
                    If Class_VariablesGlobales.LimpiarGastoAgente = True Then
                        limpiar()
                    End If
        ...
        Else
            ...
            Else
                If Class_VariablesGlobales.Gastos_llamadaDesde = "LIQUIDACION" Then
                    Class_VariablesGlobales.Obj_Funciones_SQL.ActualizaGasto(Class_VariablesGlobales.SQL_Comman1, txb_NumDoc.Text, txb_Monto.Text, txb_Descripcion.Text, Trim(Cbx_Tipo.Text), liqNum, Class_VariablesGlobales.TipoLiqui, Trim(txb_CodAgente.Text), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(dtp_FechaGasto.Value), Txtb_DocNum.Text, CBox_IncluidoEnLiquidacion.Checked, False)
                    dgv_DetGastos.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosChoferes(Class_VariablesGlobales.SQL_Comman1, "", Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Empleado, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), "", "", False, True)
                ...
                Else
                    ...
                    Class_VariablesGlobales.Obj_Funciones_SQL.ActualizaGasto(Class_VariablesGlobales.SQL_Comman1, txb_NumDoc.Text, txb_Monto.Text, txb_Descripcion.Text, Trim(Cbx_Tipo.Text), txb_Liquidacion.Text, "AGENTES", Trim(txb_CodAgente.Text), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(dtp_FechaGasto.Value), Txtb_DocNum.Text, CBox_IncluidoEnLiquidacion.Checked, False)
                End If
    ...
    Public Function Nuevo()
        ...
        If Class_VariablesGlobales.Gastos_llamadaDesde = "LIQUIDACION" Then
            If Class_VariablesGlobales.LIQUIDANDO = "AGENTES" Then
                dgv_DetGastos.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosAgentes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Class_VariablesGlobales.Agente, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), "", "", False, CBox_IncluidoEnLiquidacion.Checked)
            Else
                dgv_DetGastos.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosAgentes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Class_VariablesGlobales.Chofer, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), "", "", False, CBox_IncluidoEnLiquidacion.Checked)
            End If
    ...
    Private Sub btn_AgElimina_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_AgElimina.Click
        ...
        If result1 = DialogResult.Yes Then
            ...
            If Class_VariablesGlobales.Gastos_llamadaDesde = "LIQUIDACION" Then
                ...
                txb_Total.Text = FormatCurrency(Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneTotalGastosAgentes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Empleado, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), False, False), 2)
                dgv_DetGastos.DataSource = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosAgentes(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.TipoLiqui, Class_VariablesGlobales.TituloDetalleGasto, Empleado, Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaIni), Class_VariablesGlobales.Obj_Fecha.FormatoFechaSql(Class_VariablesGlobales.FechaFin), "", "", False, CBox_IncluidoEnLiquidacion.Checked)
    ...
    Private Sub btn_GoToLiq_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_GoToLiq.Click
        ...
        Try
            ...
            If Class_VariablesGlobales.LIQUIDANDO = "AGENTES" Then
                ...
                tabla = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneLiquidaciones(Class_VariablesGlobales.SQL_Comman1, Class_VariablesGlobales.LIQUIDANDO, "", "", txb_Liquidacion.Text)
                Class_VariablesGlobales.NumLiqui = txb_Liquidacion.Text
    ...
    Private Sub txb_NumDoc_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txb_NumDoc.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            ...
            tablas = Class_VariablesGlobales.Obj_Funciones_SQL.ObtieneGastosAgentes(Class_VariablesGlobales.SQL_Comman1, "AGENTES", "", "", "", "", Class_VariablesGlobales.NumGastoBuscando, "", True, CBox_IncluidoEnLiquidacion.Checked)
    ...
    Private Sub btn_ReenviarMH_Click(sender As Object, e As EventArgs) Handles btn_ReenviarMH.Click
        ...
        Class_VariablesGlobales.LimpiarGastoAgente = True
    End Sub
